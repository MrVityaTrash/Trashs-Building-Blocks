...
public class GranitebrickstairsBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:granitebrickstairs")
	public static final Block block = null;
	public GranitebrickstairsBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 65);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("granitebrickstairs");
		}
