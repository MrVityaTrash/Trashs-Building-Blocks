...
public class PolishedlimestonestairsBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:polishedlimestonestairs")
	public static final Block block = null;
	public PolishedlimestonestairsBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 18);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("polishedlimestonestairs");
		}
