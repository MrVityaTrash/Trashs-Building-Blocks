...
public class DioritebrickstairBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:dioritebrickstair")
	public static final Block block = null;
	public DioritebrickstairBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 61);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("dioritebrickstair");
		}
