...
public class PolisheddepthstoneslabBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:polisheddepthstoneslab")
	public static final Block block = null;
	public PolisheddepthstoneslabBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 7);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("polisheddepthstoneslab");
		}
