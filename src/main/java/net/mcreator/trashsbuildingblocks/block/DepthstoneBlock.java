...
public class DepthstoneBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:depthstone")
	public static final Block block = null;
	public DepthstoneBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 1);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("depthstone", "depthstone", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.STONE.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 17), Placement.COUNT_RANGE, new CountRangeConfig(10, 0, 0, 32)));
		}
	}
}
