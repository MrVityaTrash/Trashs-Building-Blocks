...
public class KomatiiteBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:komatiite")
	public static final Block block = null;
	public KomatiiteBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 49);
	}
