...
public class TavertinebrickstairBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:tavertinebrickstair")
	public static final Block block = null;
	public TavertinebrickstairBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 53);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("tavertinebrickstair");
		}
