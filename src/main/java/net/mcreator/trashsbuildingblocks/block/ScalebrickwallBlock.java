...
public class ScalebrickwallBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:scalebrickwall")
	public static final Block block = null;
	public ScalebrickwallBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 96);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("scalebrickwall");
		}
