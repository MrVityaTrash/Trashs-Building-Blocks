...
public class TavertinestairBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:tavertinestair")
	public static final Block block = null;
	public TavertinestairBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 46);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("tavertinestair");
		}
