...
public class GreystonebrickwallBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:greystonebrickwall")
	public static final Block block = null;
	public GreystonebrickwallBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 71);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("greystonebrickwall");
		}
