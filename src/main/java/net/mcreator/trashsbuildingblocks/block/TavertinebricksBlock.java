...
public class TavertinebricksBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:tavertinebricks")
	public static final Block block = null;
	public TavertinebricksBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 12);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("tavertinebricks");
		}
