...
public class KomatiiteSlabBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:komatiite_slab")
	public static final Block block = null;
	public KomatiiteSlabBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 51);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("komatiite_slab");
		}
