...
public class PolishedslatestairBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:polishedslatestair")
	public static final Block block = null;
	public PolishedslatestairBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 27);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("polishedslatestair");
		}
