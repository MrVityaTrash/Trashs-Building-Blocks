...
public class FrozenBrickBlock extends TrashsBuildingBlocksModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.PACKED_ICE).sound(SoundType.GLASS).hardnessAndResistance(1f, 10f).lightValue(0));
			setRegistryName("frozen_brick");
		}
