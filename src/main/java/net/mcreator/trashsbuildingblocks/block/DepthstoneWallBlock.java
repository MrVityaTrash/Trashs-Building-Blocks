...
public class DepthstoneWallBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:depthstone_wall")
	public static final Block block = null;
	public DepthstoneWallBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 4);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("depthstone_wall");
		}
