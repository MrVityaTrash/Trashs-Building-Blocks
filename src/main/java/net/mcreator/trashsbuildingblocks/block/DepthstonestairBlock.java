...
public class DepthstonestairBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:depthstonestair")
	public static final Block block = null;
	public DepthstonestairBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 2);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("depthstonestair");
		}
