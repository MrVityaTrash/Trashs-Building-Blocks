...
public class TavertineWallBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:tavertine_wall")
	public static final Block block = null;
	public TavertineWallBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 64);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("tavertine_wall");
		}
