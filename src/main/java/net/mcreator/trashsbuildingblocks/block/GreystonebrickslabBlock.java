...
public class GreystonebrickslabBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:greystonebrickslab")
	public static final Block block = null;
	public GreystonebrickslabBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 87);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("greystonebrickslab");
		}
