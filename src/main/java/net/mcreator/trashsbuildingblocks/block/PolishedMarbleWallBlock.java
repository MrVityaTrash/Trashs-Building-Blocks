...
public class PolishedMarbleWallBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:polished_marble_wall")
	public static final Block block = null;
	public PolishedMarbleWallBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 44);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("polished_marble_wall");
		}
