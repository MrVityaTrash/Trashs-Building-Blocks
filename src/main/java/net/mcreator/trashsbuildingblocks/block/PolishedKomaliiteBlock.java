...
public class PolishedKomaliiteBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:polished_komaliite")
	public static final Block block = null;
	public PolishedKomaliiteBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 53);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("polished_komaliite");
		}
