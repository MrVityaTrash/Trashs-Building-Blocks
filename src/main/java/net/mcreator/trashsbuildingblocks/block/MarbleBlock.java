...
public class MarbleBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:marble")
	public static final Block block = null;
	public MarbleBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 34);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("marble", "marble", blockAt -> {
