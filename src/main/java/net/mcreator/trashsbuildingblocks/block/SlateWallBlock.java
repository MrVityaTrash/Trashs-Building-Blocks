...
public class SlateWallBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:slate_wall")
	public static final Block block = null;
	public SlateWallBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 28);
	}
