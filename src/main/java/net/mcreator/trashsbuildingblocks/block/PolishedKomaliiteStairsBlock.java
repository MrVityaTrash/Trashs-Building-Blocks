...
public class PolishedKomaliiteStairsBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:polished_komaliite_stairs")
	public static final Block block = null;
	public PolishedKomaliiteStairsBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 54);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("polished_komaliite_stairs");
		}
