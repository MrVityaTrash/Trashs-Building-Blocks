...
public class KomaliiteBrickStairsBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:komaliite_brick_stairs")
	public static final Block block = null;
	public KomaliiteBrickStairsBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 58);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("komaliite_brick_stairs");
		}
