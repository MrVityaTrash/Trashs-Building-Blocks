...
public class LimestonebrickstairBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:limestonebrickstair")
	public static final Block block = null;
	public LimestonebrickstairBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 20);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("limestonebrickstair");
		}
