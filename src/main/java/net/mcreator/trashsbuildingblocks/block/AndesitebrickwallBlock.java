...
public class AndesitebrickwallBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:andesitebrickwall")
	public static final Block block = null;
	public AndesitebrickwallBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 76);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("andesitebrickwall");
		}
