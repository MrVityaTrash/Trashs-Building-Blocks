...
public class GranitebrickslabBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:granitebrickslab")
	public static final Block block = null;
	public GranitebrickslabBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 66);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("granitebrickslab");
		}
