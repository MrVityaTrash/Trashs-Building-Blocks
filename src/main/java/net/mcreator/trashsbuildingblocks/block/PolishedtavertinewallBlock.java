...
public class PolishedtavertinewallBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:polishedtavertinewall")
	public static final Block block = null;
	public PolishedtavertinewallBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 68);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("polishedtavertinewall");
		}
