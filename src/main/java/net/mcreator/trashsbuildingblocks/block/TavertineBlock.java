...
public class TavertineBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:tavertine")
	public static final Block block = null;
	public TavertineBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 61);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("tavertine", "tavertine", blockAt -> {
