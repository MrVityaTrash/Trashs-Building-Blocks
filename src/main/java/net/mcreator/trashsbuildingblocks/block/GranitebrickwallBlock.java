...
public class GranitebrickwallBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:granitebrickwall")
	public static final Block block = null;
	public GranitebrickwallBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 84);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("granitebrickwall");
		}
