...
public class PolishedKomaliteSlabBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:polished_komalite_slab")
	public static final Block block = null;
	public PolishedKomaliteSlabBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 55);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("polished_komalite_slab");
		}
