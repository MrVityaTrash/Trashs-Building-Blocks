...
public class MarbleWallBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:marble_wall")
	public static final Block block = null;
	public MarbleWallBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 40);
	}
