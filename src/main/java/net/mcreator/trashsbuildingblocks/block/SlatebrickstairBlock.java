...
public class SlatebrickstairBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:slatebrickstair")
	public static final Block block = null;
	public SlatebrickstairBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 34);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("slatebrickstair");
		}
