...
public class KomaliiteBricksBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:komaliite_bricks")
	public static final Block block = null;
	public KomaliiteBricksBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 57);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("komaliite_bricks");
		}
