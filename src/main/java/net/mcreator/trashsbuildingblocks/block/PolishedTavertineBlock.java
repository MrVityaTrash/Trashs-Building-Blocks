...
public class PolishedTavertineBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:polished_tavertine")
	public static final Block block = null;
	public PolishedTavertineBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 48);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("polished_tavertine");
		}
