...
public class AndesitebrickslabBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:andesitebrickslab")
	public static final Block block = null;
	public AndesitebrickslabBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 75);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("andesitebrickslab");
		}
