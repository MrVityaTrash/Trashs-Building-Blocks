...
public class PolisheddepthstonestairBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:polisheddepthstonestair")
	public static final Block block = null;
	public PolisheddepthstonestairBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 5);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("polisheddepthstonestair");
		}
