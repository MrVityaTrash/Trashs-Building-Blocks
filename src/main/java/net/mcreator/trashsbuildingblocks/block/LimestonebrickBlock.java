...
public class LimestonebrickBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:limestonebrick")
	public static final Block block = null;
	public LimestonebrickBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 21);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("limestonebrick");
		}
