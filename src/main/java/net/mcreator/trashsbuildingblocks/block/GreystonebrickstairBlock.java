...
public class GreystonebrickstairBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:greystonebrickstair")
	public static final Block block = null;
	public GreystonebrickstairBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 69);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("greystonebrickstair");
		}
