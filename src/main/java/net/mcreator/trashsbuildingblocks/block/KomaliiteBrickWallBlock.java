...
public class KomaliiteBrickWallBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:komaliite_brick_wall")
	public static final Block block = null;
	public KomaliiteBrickWallBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 60);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("komaliite_brick_wall");
		}
