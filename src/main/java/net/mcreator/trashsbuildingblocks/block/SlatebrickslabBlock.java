...
public class SlatebrickslabBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:slatebrickslab")
	public static final Block block = null;
	public SlatebrickslabBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 35);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("slatebrickslab");
		}
