...
public class KomatiiteStairsBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:komatiite_stairs")
	public static final Block block = null;
	public KomatiiteStairsBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 50);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("komatiite_stairs");
		}
