...
public class KomaliiteWallBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:komaliite_wall")
	public static final Block block = null;
	public KomaliiteWallBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 52);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("komaliite_wall");
		}
