...
public class DepthstoneslabBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:depthstoneslab")
	public static final Block block = null;
	public DepthstoneslabBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 3);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("depthstoneslab");
		}
