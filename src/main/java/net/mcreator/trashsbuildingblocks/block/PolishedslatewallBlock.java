...
public class PolishedslatewallBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:polishedslatewall")
	public static final Block block = null;
	public PolishedslatewallBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 32);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("polishedslatewall");
		}
