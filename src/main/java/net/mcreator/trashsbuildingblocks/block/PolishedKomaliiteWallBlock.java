...
public class PolishedKomaliiteWallBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:polished_komaliite_wall")
	public static final Block block = null;
	public PolishedKomaliiteWallBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 56);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("polished_komaliite_wall");
		}
