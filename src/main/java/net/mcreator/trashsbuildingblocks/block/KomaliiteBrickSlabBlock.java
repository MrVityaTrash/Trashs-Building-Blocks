...
public class KomaliiteBrickSlabBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:komaliite_brick_slab")
	public static final Block block = null;
	public KomaliiteBrickSlabBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 59);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("komaliite_brick_slab");
		}
