...
public class TavertinebrickwallBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:tavertinebrickwall")
	public static final Block block = null;
	public TavertinebrickwallBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 72);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("tavertinebrickwall");
		}
