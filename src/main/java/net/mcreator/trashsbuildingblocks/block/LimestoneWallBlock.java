...
public class LimestoneWallBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:limestone_wall")
	public static final Block block = null;
	public LimestoneWallBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 16);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("limestone_wall");
		}
