...
public class ScalebrickslabBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:scalebrickslab")
	public static final Block block = null;
	public ScalebrickslabBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 78);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("scalebrickslab");
		}
