...
public class PolishedlimestonewallBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:polishedlimestonewall")
	public static final Block block = null;
	public PolishedlimestonewallBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 18);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("polishedlimestonewall");
		}
