...
public class DepthstonebrickslabBlock extends TrashsBuildingBlocksModElements.ModElement {
	@ObjectHolder("trashs_building_blocks:depthstonebrickslab")
	public static final Block block = null;
	public DepthstonebrickslabBlock(TrashsBuildingBlocksModElements instance) {
		super(instance, 11);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("depthstonebrickslab");
		}
